...
namespace BudgetManager.Services
{
    public class TagService : ITagService
    {
        ...
        public async Task<ListResponse<TagsListItemDto>> ListAsync(ListTagsRequest request)
        {
        ...
        public async Task<ResultResponse<TagDto>> GetAsync(int id)
        {
            var tag = await _tagRepository.GetAsync(tag => tag.Id == id);
        ...
        public async Task<BaseResponse> AddAsync(AddTagRequest request)
        {
        ...
        public async Task<BaseResponse> EditAsync(EditTagRequest request)
        {
            var tag = await _tagRepository.GetAsync(tag => tag.Id == request.Id);
